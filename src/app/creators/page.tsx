...
import { CREATOR_DESCRIPTION } from "@/lib/constants";

const TITLE = "Portsmouth Creators | Join Discovered Local";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "local content creators Portsmouth",
  ...
  twitter: { title: TITLE, description: CREATOR_DESCRIPTION },
};
...
/**
 * Line icons rather than emoji: they inherit `currentColor`, sit on the same
 * 1.5 stroke as the rest of the site and render identically on every platform.
 */
const BENEFITS = [
  {
    title: "Complimentary experiences",
    copy: "Discover restaurants, cafés and local businesses through creator opportunities.",
    icon: (
      <>
        <path d="M6.5 3v5a3 3 0 0 0 6 0V3M9.5 3v5M9.5 11v10" />
        <path d="M17 3c1.5 1.6 1.5 5.4 0 7v11" />
      </>
    ),
  },
  {
    ...
    icon: (
      <>
        ...
        <path d="M10.8 9.4v5.2l4.2-2.6-4.2-2.6Z" fill="currentColor" stroke="none" />
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    copy: "Reliable creators who create good content will get access to more collaborations.",
    icon: (
      <>
        <path d="M6 8h9a4 4 0 0 1 4 4M9 5 6 8l3 3" />
        <path d="M18 16H9a4 4 0 0 1-4-4M15 19l3-3-3-3" />
      </>
    ),
  },
];
...
const CRITERIA = [
  ...
  "You’re reliable",
  "You actually want to discover new places",
];

export default function CreatorsPage() {
  return (
    <>
      <PageViewTracker event="creator_page_view" />
      ...
      <main id="main">
            ...
            <div>
              ...
              <Reveal delay={60}>
                <h1 className="h-display mt-6">
                  ...
                  Create content.
                  <br />
                  <span className="serif-accent text-accent-deep">
                    Get invited back.
                  </span>
                </h1>
              </Reveal>
              ...
              <Reveal delay={180}>
                <div className="mt-8 flex flex-col items-start gap-3">
                  <ApplyCta location="creator_hero" className="w-full sm:w-auto">
                    Become a creator
                  </ApplyCta>
          ...
          <div className="container-page grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-20">
            <Reveal>
              ...
              <h2 className="h-section mt-4">
                Great local places need{" "}
                <span className="serif-accent">great local creators.</span>
              </h2>
            </Reveal>
        ...
        <section id="how-it-works" className="container-page py-20 sm:py-28">
          ...
          <Reveal delay={120}>
            <div className="mt-14">
              <FlowChain
                steps={[
                  { step: "creator", label: "You", detail: "A local creator" },
                  {
                    step: "business",
                    label: "A great local place",
                    detail: "Matched by us",
                  },
                  {
                    step: "audience",
              ...
              {BENEFITS.map((benefit, index) => (
                <Reveal as="article" key={benefit.title} delay={index * 70}>
                  <div className="h-full rounded-2xl border border-line bg-paper p-6">
                    <span
                      aria-hidden
                      className="grid size-11 place-items-center rounded-xl border border-line bg-paper-deep text-accent-deep"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        className="size-5"
          ...
          <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-20">
            <Reveal>
              ...
              <h2 className="h-section mt-4">
                ...
                <span className="serif-accent">100k followers.</span>
              </h2>
        ...
        <section className="border-y border-line bg-ink py-20 text-paper sm:py-28">
          <div className="container-page grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-20">
            ...
            <Reveal
              delay={80}
              className="max-w-2xl space-y-5 text-lg leading-relaxed text-paper/70 lg:pt-2"
            >
              <p>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-line bg-paper-deep px-6 py-16 text-center sm:px-12 sm:py-24">
              ...
              <div className="relative mx-auto max-w-2xl">
                <h2 className="h-section">
                  Want to discover{" "}
                  <span className="serif-accent">what&rsquo;s next?</span>
                </h2>
                ...
                <div className="mt-9 flex flex-col items-center gap-3">
                  <ApplyCta location="creator_footer_cta" className="w-full sm:w-auto" />
